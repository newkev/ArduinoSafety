...
$(function() {
    ...
    function ArduinoSafetyViewModel(parameters) {
        var self = this;
        ...
        self.onBeforeBinding = function() {
            ...
            if (element.length) {
                ...
                element.before("<div id='costestimation_string' data-bind='visible: true'><span title='" + text + "'>" + name + "</span>: <strong data-bind='text: estimatedCostString'></strong></div>");
            }
        };
    }

    OCTOPRINT_VIEWMODELS.push({
        construct: ArduinoSafetyViewModel,
        ...
        elements: ["#arduinosafety_string", "#settings_plugin_arduinosafety"]
    });
});